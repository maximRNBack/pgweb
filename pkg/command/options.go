...
type Options struct {
	...
	ServerSessions bool   `long:"server-sessions" description:"Enable multiple database sessions (server side sessions)" default:"false"`
...
func ParseOptions() error {
	...
	if os.Getenv("SERVER_SESSIONS") != "" {
		Opts.ServerSessions = true
	}
